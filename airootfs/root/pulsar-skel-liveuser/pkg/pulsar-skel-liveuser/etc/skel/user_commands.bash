...
# Pulsar install (in online mode only) on the target system.
#
...
# with terminal command 'pulsar-welcome' after saving this file.
#
...
_PostInstallCommands() {
    ...
    # echo "alias pacdiff=pulsar-pacdiff" >> /home/$username/.bashrc
